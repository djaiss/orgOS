<x-marketing-docs-layout :breadcrumbItems="[
  ...
  <div class="py-16">
    ...
    <div class="mb-10 border-b border-gray-200 pb-10 dark:border-gray-700">
      ...
      <p class="mb-4">
        An organization is the central workspace in orgOS. Everything — members, offices, departments, and all
        administrative settings — lives inside an organization. Think of it as your company's home inside the product.
      </p>
      <p class="mb-4">
        When Michael Scott sets up Dunder Mifflin Paper Company in orgOS, he is creating an organization. Every person
        he invites, every office he registers, and every department he defines all belong to that one organization.
      </p>
      <p>
        An organization has a <strong>name</strong> and a unique <strong>slug</strong> that is used in URLs. It also
        has an <strong>invitation code</strong> — a secret string that lets other people join it.
      </p>
    </div>
    ...
    <div class="mb-10 border-b border-gray-200 pb-10 dark:border-gray-700">
      ...
      <p class="mb-6">
        Every person inside an organization has a role. The role determines what that person can see and do.
        orgOS defines four roles, from most to least privileged:
      </p>
      ...
      <p>
        The person who creates an organization is automatically given the <strong>Owner</strong> role.
        Owners and Administrators can update the roles of other members from Adminland.
      </p>
    </div>
    ...
    <div class="mb-10 border-b border-gray-200 pb-10 dark:border-gray-700">
      ...
      <p class="mb-4">
        Any authenticated user can create a new organization. Once created, that user becomes its <strong>Owner</strong>.
      </p>
      <ol class="mb-4 list-decimal space-y-2 pl-6">
        <li>From your dashboard, click <strong>Create an organization</strong>.</li>
      ...
      <p>
        After creation, orgOS runs a background job to pre-populate the organization with sensible defaults so you can
    ...
    <div class="mb-10 border-b border-gray-200 pb-10 dark:border-gray-700">
      ...
      <p class="mb-4">
        You do not need to create your own organization to use orgOS. If your company is already set up, an Owner or
        Administrator can share the organization's <strong>invitation code</strong> with you, and you can use it to join.
      </p>
      <p class="mb-4">
        When Pam Beesly joins Dunder Mifflin in orgOS, Michael simply gives her the invitation code. She enters it on
        the <em>Join an organization</em> screen, and she is immediately added as a <strong>Member</strong>.
      </p>
      <ol class="mb-4 list-decimal space-y-2 pl-6">
        <li>From your dashboard, click <strong>Join an organization</strong>.</li>
      ...
      <p class="mb-4">
        The invitation code is a long random string — keep it private. Anyone who has it can join the organization.
        If the code is ever compromised, an Owner or Administrator can regenerate it from Adminland.
      </p>
      <p>
        You cannot join an organization you are already a member of. orgOS will tell you so and prevent a duplicate
        membership from being created.
      </p>
    </div>
    ...
    <div class="mb-10 border-b border-gray-200 pb-10 dark:border-gray-700">
      ...
      <p class="mb-4">
        A single user account can belong to more than one organization simultaneously. This is useful for consultants,
        contractors, or anyone who works across multiple companies.
      </p>
      <p>
        Each membership is independent — your role in one organization has no effect on your role in another. You can
        switch between organizations from your dashboard at any time.
      </p>
    </div>
    ...
    <div class="mb-10 border-b border-gray-200 pb-10 dark:border-gray-700">
      ...
      <p class="mb-4">
        <strong>Adminland</strong> is the administration area of your organization. It is only accessible to users
        with the <strong>Owner</strong> or <strong>Administrator</strong> role.
      </p>
