<x-box padding="p-0">
  ...
  <div id="member-type-list">
    @foreach ($memberTypes as $memberType)
      <div id="member-type-{{ $memberType->id }}" class="group flex items-center justify-between border-b border-gray-200 p-3 first:rounded-t-lg last:rounded-b-lg last:border-b-0 hover:bg-blue-50 dark:border-gray-700 dark:hover:bg-gray-800">
